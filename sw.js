const CACHE_NAME="trace-racing-v8";
const SHELL=["./","./index.html","./style.css","./game.js","./manifest.json","./icons/icon-192.png","./icons/icon-512.png","./icons/maskable-512.png","./icons/favicon.png","./icons/apple-touch-icon.png"];
